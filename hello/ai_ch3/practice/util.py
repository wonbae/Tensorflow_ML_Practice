...
class LinkedList(tuple):
    ...
    def cons(self, el):         # construct a new list by append an element
        return LinkedList((el, self))

    def car(self):              # return the head of the list
        return self[0] if self is not LinkedList.NIL else self

    def cdr(self):              # return the remaining list where the head is excluded
